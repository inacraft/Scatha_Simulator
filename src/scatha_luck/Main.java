...
public class Main {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println("Finally, Enter the delay between worms kills [in milliseconds] (0 = Instant results | 100 = Recommended ) :");
		...
		if((nbPetRare+nbPetEpic+nbPetLeg) > 1) {
			...
			System.out.println("Number of Epic Scatha Pet : " + nbPetEpic);
			System.out.println("Number of Rare Scatha Pet : " + nbPetRare);
			System.out.println("Number of total Scatha Pet : " + (nbPetRare+nbPetEpic+nbPetLeg));
		}
	}
}
